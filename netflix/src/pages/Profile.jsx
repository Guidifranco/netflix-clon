...
const Profile = () => {
  ...
  return (
    ...
    <div>
      <div>
        <img className="block w-full h-[500px] object-cover" src="https://assets.nflxext.com/ffe/siteui/vlv3/c1366fb4-3292-4428-9639-b73f25539794/82be6b6c-7053-4d4a-8c1c-072cd169a68e/AR-es-20240408-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="//" />
    ...
    <div className="relative flex items-center group">
      ...
      {movies.map((movie) => (
        ...
        <img className="w-full h-40 object-cover object-top" src={createImageUrl(movie.backdrop_path ?? movie.poster_path, "w500")} alt={movie.title} />
