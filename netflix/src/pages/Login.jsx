...
const Login = () => {
  ...
  return (
    ...
    <div className="w-full h-screen">
      <img className="hidden sm:block absolute w-full h-full object-cover" src="https://assets.nflxext.com/ffe/siteui/vlv3/c1366fb4-3292-4428-9639-b73f25539794/82be6b6c-7053-4d4a-8c1c-072cd169a68e/AR-es-20240408-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="///" />
        ...
        <div className="max-w-[450px] h-[600px] mx-auto bg-black/80 rounded-lg">
          <div className="max-w-[320px] mx-auto py-16">
            ...
            <form onSubmit={handleFormSubmit} className="w-full flex flex-col py-4">
              ...
              <div className="flex justify-between items-center to-gray-600">
                <p>
              ...
              <p className="my-4">
                <span className="to-gray-600 mr-2">
                 New to Netflix?
                </span>
